...
import com.lukasanda.smashedpixeldungeon.actors.blobs.WellWater;
...
import com.lukasanda.smashedpixeldungeon.actors.buffs.LockedFloor;
import com.lukasanda.smashedpixeldungeon.actors.buffs.MindVision;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Shadows;
import com.lukasanda.smashedpixeldungeon.actors.hero.Hero;
import com.lukasanda.smashedpixeldungeon.actors.hero.HeroClass;
import com.lukasanda.smashedpixeldungeon.actors.mobs.Mob;
import com.lukasanda.smashedpixeldungeon.effects.particles.FlowParticle;
import com.lukasanda.smashedpixeldungeon.effects.particles.WindParticle;
...
import com.lukasanda.smashedpixeldungeon.levels.features.HighGrass;
import com.lukasanda.smashedpixeldungeon.levels.painters.Painter;
import com.lukasanda.smashedpixeldungeon.levels.rooms.special.MassGraveRoom;
import com.lukasanda.smashedpixeldungeon.levels.traps.Trap;
import com.lukasanda.smashedpixeldungeon.mechanics.ShadowCaster;
...
public abstract class Level implements Bundlable {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		if (version < SmashedPixelDungeon.v0_4_3c){
		...
		// pre-0.6.1 saves
		if (version <= SmashedPixelDungeon.v0_6_0b){
	...
	public Heap drop( Item item, int cell, float chance){
		//A simple mechanic for dropping universal loot from enemies
		if(Random.Float()<chance){
			return drop(item,cell);
		} else {
			return drop(null, cell);
		}
	}
