...
import com.lukasanda.smashedpixeldungeon.Rankings;
...
public class WelcomeScene extends PixelScene {
	...
	private static int LATEST_UPDATE = SmashedPixelDungeon.v0_6_4;
	...
	public void create() {
		...
		if (SmashedPixelDungeon.versionCode == previousVersion) {
		...
		DarkRedButton okay = new DarkRedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				SmashedPixelDungeon.switchScene(TitleScene.class);
			}
		};
		...
		if (previousVersion != 0){
			DarkRedButton changes = new DarkRedButton(Messages.get(this, "changelist")){
				...
				protected void onClick() {
					super.onClick();
					updateVersion(previousVersion);
					SmashedPixelDungeon.switchScene(ChangesScene.class);
				}
			};
		...
		} else if (previousVersion <= SmashedPixelDungeon.versionCode) {
	...
	private void updateVersion(int previousVersion){
		...
		if (previousVersion <= SmashedPixelDungeon.v0_6_2e){
		...
		if (previousVersion <= SmashedPixelDungeon.v0_6_0b){
		...
		SPDSettings.version(SmashedPixelDungeon.versionCode);
	}
