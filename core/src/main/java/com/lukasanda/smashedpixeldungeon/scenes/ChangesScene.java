...
import com.lukasanda.smashedpixeldungeon.Chrome;
...
import com.lukasanda.smashedpixeldungeon.items.food.Blandfruit;
...
import com.lukasanda.smashedpixeldungeon.items.stones.StoneOfEnchantment;
...
import com.lukasanda.smashedpixeldungeon.ui.ScrollPane;
import com.lukasanda.smashedpixeldungeon.ui.Window;
import com.lukasanda.smashedpixeldungeon.windows.WndTitledMessage;
...
public class ChangesScene extends PixelScene {
	...
	private static class ChangeButton extends Component {
		...
		protected void onClick() {
			SmashedPixelDungeon.scene().add(new ChangesWindow(new Image(icon), title, message));
		}
