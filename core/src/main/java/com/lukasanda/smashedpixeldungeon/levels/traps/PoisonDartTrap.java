...
import com.lukasanda.smashedpixeldungeon.items.weapon.missiles.darts.PoisonDart;
import com.lukasanda.smashedpixeldungeon.mechanics.Ballistica;
import com.lukasanda.smashedpixeldungeon.sprites.MissileSprite;
			...
			if (Dungeon.level.heroFOV[pos] || Dungeon.level.heroFOV[target.pos]) {
				Actor.add(new Actor() {
					...
					protected boolean act() {
						...
						((MissileSprite) SmashedPixelDungeon.scene().recycle(MissileSprite.class)).
