...
package com.lukasanda.smashedpixeldungeon.items.weapon;
...
import com.lukasanda.smashedpixeldungeon.items.weapon.curses.Annoying;
import com.lukasanda.smashedpixeldungeon.items.weapon.curses.Displacing;
import com.lukasanda.smashedpixeldungeon.items.weapon.curses.Exhausting;
import com.lukasanda.smashedpixeldungeon.items.weapon.curses.Fragile;
import com.lukasanda.smashedpixeldungeon.items.weapon.curses.Sacrificial;
import com.lukasanda.smashedpixeldungeon.items.weapon.curses.Wayward;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Blazing;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Chilling;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Dazzling;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Eldritch;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Grim;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Lucky;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Projecting;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Shocking;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Stunning;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Unstable;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Vampiric;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Venomous;
import com.lukasanda.smashedpixeldungeon.items.weapon.enchantments.Vorpal;
