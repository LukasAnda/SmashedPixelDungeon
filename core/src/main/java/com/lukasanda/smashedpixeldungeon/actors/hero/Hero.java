...
import com.lukasanda.smashedpixeldungeon.Bones;
import com.lukasanda.smashedpixeldungeon.Dungeon;
import com.lukasanda.smashedpixeldungeon.GamesInProgress;
import com.lukasanda.smashedpixeldungeon.Statistics;
...
import com.lukasanda.smashedpixeldungeon.actors.buffs.Berserk;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Bless;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Buff;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Combo;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Drowsy;
import com.lukasanda.smashedpixeldungeon.actors.buffs.FlavourBuff;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Fury;
...
import com.lukasanda.smashedpixeldungeon.actors.buffs.Momentum;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Paralysis;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Regeneration;
import com.lukasanda.smashedpixeldungeon.actors.buffs.SnipersMark;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Vertigo;
import com.lukasanda.smashedpixeldungeon.actors.buffs.Weakness;
import com.lukasanda.smashedpixeldungeon.actors.mobs.Mob;
import com.lukasanda.smashedpixeldungeon.actors.mobs.npcs.NPC;
import com.lukasanda.smashedpixeldungeon.effects.CellEmitter;
import com.lukasanda.smashedpixeldungeon.effects.CheckedCell;
import com.lukasanda.smashedpixeldungeon.effects.Flare;
import com.lukasanda.smashedpixeldungeon.effects.Speck;
import com.lukasanda.smashedpixeldungeon.items.Amulet;
...
import com.lukasanda.smashedpixeldungeon.items.Heap.Type;
...
import com.lukasanda.smashedpixeldungeon.items.armor.glyphs.AntiMagic;
import com.lukasanda.smashedpixeldungeon.items.armor.glyphs.Flow;
import com.lukasanda.smashedpixeldungeon.items.armor.glyphs.Obfuscation;
import com.lukasanda.smashedpixeldungeon.items.armor.glyphs.Stone;
import com.lukasanda.smashedpixeldungeon.items.armor.glyphs.Swiftness;
import com.lukasanda.smashedpixeldungeon.items.armor.glyphs.Viscosity;
...
import com.lukasanda.smashedpixeldungeon.items.keys.CrystalKey;
import com.lukasanda.smashedpixeldungeon.items.keys.GoldenKey;
import com.lukasanda.smashedpixeldungeon.items.keys.IronKey;
import com.lukasanda.smashedpixeldungeon.items.keys.Key;
import com.lukasanda.smashedpixeldungeon.items.keys.SkeletonKey;
...
import com.lukasanda.smashedpixeldungeon.journal.Notes;
import com.lukasanda.smashedpixeldungeon.levels.Level;
import com.lukasanda.smashedpixeldungeon.levels.Terrain;
import com.lukasanda.smashedpixeldungeon.levels.features.Chasm;
...
import com.lukasanda.smashedpixeldungeon.scenes.SurfaceScene;
import com.lukasanda.smashedpixeldungeon.sprites.CharSprite;
import com.lukasanda.smashedpixeldungeon.sprites.HeroSprite;
import com.lukasanda.smashedpixeldungeon.ui.AttackIndicator;
import com.lukasanda.smashedpixeldungeon.ui.BuffIndicator;
import com.lukasanda.smashedpixeldungeon.ui.QuickSlotButton;
import com.lukasanda.smashedpixeldungeon.utils.BArray;
import com.lukasanda.smashedpixeldungeon.utils.GLog;
import com.lukasanda.smashedpixeldungeon.windows.WndAlchemy;
import com.lukasanda.smashedpixeldungeon.windows.WndMessage;
import com.lukasanda.smashedpixeldungeon.windows.WndResurrect;
import com.lukasanda.smashedpixeldungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	public int defenseSkill( Char enemy ) {
		...
		return Math.round((defenseSkill * multiplier * defenceMultiplier) + bonus);
	}
	...
	public void multiplyDef(float multiplier){
