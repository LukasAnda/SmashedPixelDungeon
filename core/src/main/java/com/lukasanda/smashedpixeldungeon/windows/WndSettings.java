...
import com.lukasanda.smashedpixeldungeon.ui.CheckBox;
import com.lukasanda.smashedpixeldungeon.ui.OptionSlider;
		...
		public DisplayTab() {
			...
			OptionSlider scale = new OptionSlider(Messages.get(this, "scale"),
				...
				protected void onChange() {
					if (getSelectedValue() != SPDSettings.scale()) {
						...
						SmashedPixelDungeon.switchNoFade((Class<? extends PixelScene>) SmashedPixelDungeon.scene().getClass(), new Game.SceneChangeCallback() {
							@Override
			...
			CheckBox chkSaver = new CheckBox( Messages.get(this, "saver") ) {
				...
				protected void onClick() {
					...
					if (checked()) {
						checked(!checked());
						SmashedPixelDungeon.scene().add(new WndOptions(
